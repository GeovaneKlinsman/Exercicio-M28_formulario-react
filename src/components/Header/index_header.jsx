...
const Header = () => {
    return (
        <header className={styles.header}>
            ...
            <img className={styles.headerImg} src="https://raw.githubusercontent.com/AndreDG88/tarefa_m28_react/refs/heads/main/src/images/imagem_header_site-imc.png" alt="logo site IMC" />
        </header>
    )
}
